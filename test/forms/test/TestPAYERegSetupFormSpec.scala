...
import models.api.{CompanyDetails, Director, Employment, PAYEContact, PAYERegistration, SICCode}
  ...
  "Binding TestPAYERegSetupForm to a model" when {
    "Bind successfully with full data" should {
      val data = Map(
        ...
        "directors[0].name" -> "Sir Thierry Dom Henry",
        "directors[0].nino" -> "ZZ12345C",
        "directors[1].name" -> "Mr David Michel Trezeguet",
      ...
      val model = PAYERegistration(
        ...
        directors = List(
          Director("Sir Thierry Dom Henry", Some("ZZ12345C")),
          Director("Mr David Michel Trezeguet", Some("SR12345A"))
        ),
    ...
    "Bind successfully with not full data" should {
      val data = Map(
        ...
        "directors[0].name" -> "Thierry Henry",
        "directors[0].nino" -> "ZZ12345C",
        "directors[1].name" -> "David Trezeguet",
        "directors[1].nino" -> "SR12345A",
        "payeContact.payeContactDetails.name" -> "tata",
        "payeContact.payeContactDetails.digitalContactDetails.email" -> "tata@test.com",
        "payeContact.payeContactDetails.digitalContactDetails.mobileNumber" -> "123456",
      ...
      val model = PAYERegistration(
        ...
        directors = List(
          Director("Thierry Henry", Some("ZZ12345C")),
          Director("David Trezeguet", Some("SR12345A"))
        ),
        payeContact = PAYEContact(
          contactDetails = PAYEContactDetails(
            name = "tata",
